...
jsonLd:
  ...
  "@type": "Article"
  "headline": "How to Master Behavioral Interview Questions in 2025"
  "description": "A crisp, proven playbook for answering behavioral interview questions with the STAR method—plus templates, examples, and a prep checklist."
  "author":
    "@type": "Person"
    "name": "Mockstars Team"
  ...
  "mainEntity":
    "@type": "HowTo"
    "name": "Answer behavioral questions with the STAR method"
    "step": [
      {"@type": "HowToStep", "name": "Situation", "text": "Brief context (1–2 lines)"},
      {"@type": "HowToStep", "name": "Task", "text": "Your responsibility or goal"},
      {"@type": "HowToStep", "name": "Action", "text": "What you did (verbs + specifics)"},
      {"@type": "HowToStep", "name": "Result", "text": "Measurable outcome + learning"}
    ]
