      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-800 font-sora">2. How We Use Your Information</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-800 font-sora">3. Data Storage and Security</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-800 font-sora">4. Your Rights</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-800 font-sora">5. Contact Us</h2>
