...
import { Upload, Star, Check, Camera, FileText, Linkedin } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 max-w-6xl mx-auto">
            <div className="max-w-2xl">
              ...
              <div className="flex justify-start gap-4">
                <Button 
                  className="bg-white hover:bg-blue/90 text-blue text-base py-6 px-8 rounded-full font-mattone border border-blue/20 flex items-center justify-center max-w-sm"
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-blue/5 rounded-lg">
                        <div className="flex items-center gap-3">
                          <FileText className="h-6 w-6 text-blue animate-pulse" />
                          <div className="flex-1">
