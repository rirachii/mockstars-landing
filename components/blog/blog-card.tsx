...
export function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <Link href={post.url} className="group block">
      <article className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-200">
        {post.image && (
