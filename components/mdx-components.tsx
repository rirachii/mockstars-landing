...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h4: ({ children }) => (
      <h4 className="text-xl font-semibold mb-3 mt-6 text-gray-900 dark:text-gray-100">
        {children}
      </h4>
    ),
    p: ({ children }) => (
    ...
    ol: ({ children }) => (
      <ol className="mb-6 space-y-2 text-gray-700 dark:text-gray-300 list-decimal list-inside">
        {children}
      </ol>
    ),    li: ({ children }) => (
    ...
    blockquote: ({ children }) => (
      <blockquote className="border-l-4 border-blue-500 pl-4 mb-6 italic text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-4 rounded-r">
        {children}
      </blockquote>
    ),
    code: ({ children }) => (
